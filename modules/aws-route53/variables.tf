...
variable "route53_iam_user_name" {
  type    = string
  default = "cert-manager"

  description = <<-EOT
    The name of the IAM user that will be used to manage Route53 DNS records.
    This user should have the necessary permissions to create, update, and delete DNS entries.
    Default is "cert-manager".
  EOT
}
