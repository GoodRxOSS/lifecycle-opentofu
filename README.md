...
| <a name="input_openstack_auth"></a> [openstack\_auth](#input\_openstack\_auth) | OpenStack authentication credentials. <br/>Includes user\_name, password, and auth\_url. | <pre>object({<br/>    user_name = string<br/>    password  = string<br/>    auth_url  = string<br/>  })</pre> | <pre>{<br/>  "auth_url": "",<br/>  "password": "",<br/>  "user_name": ""<br/>}</pre> | no |
